...
export default {
  ...
  methods: {
    ...
    updateMissionID: function (m_id) {
      ...
      if(this.filterByKey("report_response", "mission_id", this.$route.params.mission_id).length === 0){
      ...
      if(this.filterByKey("briefings", "mission_id", this.$route.params.mission_id).length === 0){
